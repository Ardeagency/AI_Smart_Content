...
const TOPES = {
  hexEnCss: 243,  // 25/09 Tareas v1: fuera colores por tarea, puntos de estado y CSS muerto de historial
  importantEnCss: 171,  // 25/09 escalas: el reduced-motion global ya no fuerza animation-* con !important
  zIndexDistintos: 19,
  hexEnJs: 54,
  styleEnLineaEnJs: 121,
  innerHtml: 134,
  catchVacios: 35,
  fromEnVistas: 70,
};
