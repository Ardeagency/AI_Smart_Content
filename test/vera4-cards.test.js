...
const EJEMPLO = {
  ...
  supuesto_punto_ciego: { items: [{ perfil: 'Tosh', rol: 'competidor_directo', que_cree: 'Que el volumen de distribución compra el territorio funcional', veredicto: 'se_equivoca', en_que_se_equivoca: 'La credencial de ingrediente no se compra con pauta', evidencia_de_la_grieta: 'Sus comentarios preguntan por la lista de ingredientes', que_lo_desmentiria: 'Que sus posts sin credencial vendan igual que los que la explican', como_se_explota: 'Mostrar el maní sin explicación', confianza: 'media' }] },
