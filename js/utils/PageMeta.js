...
(function () {
  ...
  const ROUTE_LABELS = [
    [new RegExp(`${ORG}/dashboard$`),                          'Análisis de la Marca'],
    ...
    [new RegExp(`${ORG}/command-center(/.+)?$`),               'Marketing'],
    [new RegExp(`${ORG}/product-detail/.+$`),                  'Product'],
    [new RegExp(`${ORG}/products$`),                           'Products'],
    [new RegExp(`${ORG}/services$`),                           'Services'],
    [new RegExp(`${ORG}/identities(/.+)?$`),                   'Products'],
    ...
    [/^\/dashboard$/,                                          'Análisis de la Marca'],
