/**
 * BrandOrganizationView — ColorEditor mixin.
 *
 * Modal de edición de color (rueda tono + plano S/L + input hex) y CRUD de
 * brand_colors para la vista de organización. Lógica equivalente al mixin de
 * BrandstorageView; en un round futuro se puede unificar.
 *
...
(function () {
  ...
  if (typeof BrandOrganizationView === 'undefined') {
    console.warn('[ColorEditor.mixin] BrandOrganizationView no disponible; se aborta el mixin.');
    return;
  }
  ...
  Object.assign(BrandOrganizationView.prototype, ColorEditorMixin);
})();
