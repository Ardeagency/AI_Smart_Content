/**
 * BrandOrganizationView — Typography mixin.
 *
 * Dropdown de tipografía para imágenes con preview vía Google Fonts y
 * persistencia en brand_fonts. Equivalente al mixin de BrandstorageView
 * (en un round futuro se puede unificar en un solo mixin compartido).
 *
...
(function () {
  ...
  if (typeof BrandOrganizationView === 'undefined') {
    console.warn('[Typography.mixin] BrandOrganizationView no disponible; se aborta el mixin.');
    return;
  }
  ...
  Object.assign(BrandOrganizationView.prototype, TypographyMixin);
})();
