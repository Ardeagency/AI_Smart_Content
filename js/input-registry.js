...
(function (global) {
  ...
  function getDefaultTemplates() {
    return [
      { id: 'string', name: 'Texto (String)', description: 'Campo de texto: una línea, multilínea o instrucción de IA (modo configurable)', category: 'basic', icon_name: 'textbox', base_schema: { input_type: 'string', type: 'string', data_type: 'string', mode: 'single_line', placeholder: '', maxLength: 255, rows: 4 } },
