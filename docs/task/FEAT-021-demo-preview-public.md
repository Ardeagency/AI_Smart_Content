...
| Layer | File | Notes |
|---|---|---|
| **SQL bootstrap** | `SQL/migrations/2026_05_19_demo_mode_bootstrap.sql` | RESTRICTIVE policies on 86 org-scoped tables + 17 sensitive-SELECT blocks + auto-join trigger + cron cleanup |
