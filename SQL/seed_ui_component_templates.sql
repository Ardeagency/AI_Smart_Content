...
SELECT * FROM (VALUES
  ...
  ('stepper_num', 'Num Stepper', 'controls', 'caret-up-down', '{"input_type":"stepper_num","type":"stepper_num","data_type":"number","min":0,"max":999,"step":1,"defaultValue":0,"unit":""}'::jsonb, '{}'::jsonb, true, 72),
  ('selection_checkboxes', 'Checkboxes (opciones)', 'basic', 'list-checks', '{"input_type":"selection_checkboxes","type":"selection_checkboxes","data_type":"array","display_style":"selection_checkboxes","options":[{"value":"1","label":"Opción 1"},{"value":"2","label":"Opción 2"}]}'::jsonb, '{}'::jsonb, true, 65),
  ...
  ('toggle_switch', 'Toggle Switch', 'controls', 'toggle-right', '{"input_type":"toggle_switch","type":"toggle_switch","data_type":"boolean","display_style":"switch","defaultValue":false}'::jsonb, '{}'::jsonb, true, 76),
