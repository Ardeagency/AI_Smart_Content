...
FROM (VALUES
  ...
  ('colores', 'Círculos de colores seleccionables (como brands). Máx. 6. Paleta configurable.', 'basic', 'palette', '{"input_type":"colores","type":"colores","data_type":"array","max_selections":6,"options":[{"value":"#000000","label":"Negro"},{"value":"#ef4444","label":"Rojo"},{"value":"#22c55e","label":"Verde"},{"value":"#3b82f6","label":"Azul"},{"value":"#eab308","label":"Amarillo"},{"value":"#8b5cf6","label":"Violeta"}]}'::jsonb, '{}'::jsonb, true, 56),
  ('aspect_ratio', 'Formato de producción (1:1, 16:9, etc.). Grid de tarjetas con icono.', 'basic', 'crop', '{"input_type":"aspect_ratio","type":"aspect_ratio","data_type":"string","defaultValue":"1:1","options":[{"value":"1:1","label":"1:1"},{"value":"2:3","label":"2:3"},{"value":"3:2","label":"3:2"},{"value":"4:3","label":"4:3"},{"value":"3:4","label":"3:4"},{"value":"4:5","label":"4:5"},{"value":"5:4","label":"5:4"},{"value":"16:9","label":"16:9"},{"value":"9:16","label":"9:16"},{"value":"21:9","label":"21:9"}]}'::jsonb, '{}'::jsonb, true, 57),
  ('scope_picker', 'Enfoque de la producción. Toggle «Que la IA decida» y opciones personalizables.', 'basic', 'target', '{"input_type":"scope_picker","type":"scope_picker","data_type":"object","options":[]}'::jsonb, '{}'::jsonb, true, 58),
