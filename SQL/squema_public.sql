...
CREATE TABLE public.credit_logs (
  ...
  CONSTRAINT credit_logs_user_id_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id),
  CONSTRAINT credit_logs_user_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id),
  CONSTRAINT credit_logs_payment_id_fkey FOREIGN KEY (payment_id) REFERENCES public.payments(id)
);
CREATE TABLE public.credits (
  ...
  CONSTRAINT credits_user_fkey FOREIGN KEY (user_id) REFERENCES auth.users(id)
);
...
CREATE TABLE public.user_profiles (
  ...
  CONSTRAINT user_profiles_default_project_id_fkey FOREIGN KEY (default_project_id) REFERENCES public.projects(id)
);
